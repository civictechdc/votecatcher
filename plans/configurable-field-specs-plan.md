...
| G4: Persistence Layer | ⬜ Not started | — | Fixed: added `list_regions` to Protocol (#2); noted `name` column gap (#3); added model_imports.py/data/models.py registration (#17) |
| G5: Application Service | ⬜ Not started | — | |
| G6: Spec Loading & Startup | ⬜ Not started | — | Fixed: added G6.5 DI wiring (#4); fail-fast on error (#5); conftest (#6); G6.7 region_key normalization (#13); G6.8 Region auto-creation (#16); test fixture lowercase note (#9) |
| G7: Matching Service Refactor | ⬜ Not started | — | Fixed: added G7.0 voter data adapter (#6); noted field_scores evolution (#7); G7.3a zipcode filter (#20); G7.6 full_name/is_matchable (#18); G7.7 worker.py consolidation (#24) |
