...
import structlog
from app.data.database.local.common_model import CommonSqlTable
...
from app.ocr.ocr_manager import OcrResult, OcrResultFieldValues, ReadOcrResult
from app.ocr.ocr_result_repo import CreateOcrResult
from sqlalchemy.engine.result import ScalarResult
from sqlmodel import Field, Session, SQLModel, select, table
