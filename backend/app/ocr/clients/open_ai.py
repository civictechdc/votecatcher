...
class OpenAiOcrClient:
    ...
    async def create_batch_job(self, request_data: OcrRequest) -> OcrJobStatus:
        ...
        return OcrJobStatus(
            ...
            task_id=request_data.task_id,
            created_at=datetime.fromtimestamp(batch.created_at, timezone.utc),
    ...
    async def fetch_job_status(self, job_id: str) -> OcrJobStatus:
        ...
        completed_at: int | None = (
            ...
            else batch.expired_at if batch.expired_at else batch.completed_at
        )
        ...
        return OcrJobStatus(
            ...
            status_message=f"Ocr status: {batch.status}",
            updated_at=(
                datetime.fromtimestamp(batch.in_progress_at, timezone.utc)
