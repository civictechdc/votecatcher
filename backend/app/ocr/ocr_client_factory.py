...
def resolve_provider_config(
	...
	env_provider_name = os.getenv("OCR_PROVIDER_NAME")
	env_provider_model = os.getenv("OCR_PROVIDER_MODEL")
	env_provider_api_key = os.getenv("OCR_PROVIDER_API_KEY")

	if env_provider_name and env_provider_model and env_provider_api_key:
		return ProviderConfig(
			provider=env_provider_name,
			api_key=env_provider_api_key,
